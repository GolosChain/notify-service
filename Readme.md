...
##### Формат данных рассылаемых эвентов
 ...
 reward:
     permlink <string>    // ссылка на целевой пост/коммент
     golos <number>       // награда в голосах
     golosPower <number>  // награда в силе голоса
     gbg <number>         // награда в голос/золоте

 curatorReward:
     author <string>      // автор поста/коммента, за который получена награда
     permlink <string>    // ссылка на целевой пост/коммент
     reward <number>      // награда в силе голоса
